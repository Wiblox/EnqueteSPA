...
namespace EnquteSPA.bo
{
    class ContextDbInitializer : DropCreateDatabaseAlways<Context>
    {
        protected override void Seed(Context context)
        {
            ...
            // ETAPE 1 : Génération des Enqueteur
            IList<SpaPersonne> spaPersonnes = new List<SpaPersonne>
            {
                new SpaPersonne() { Nom = "Leroy", Prenom = "Daniel", Mail = "dleroy@gmail.com", Ville = "Boulogne-Billancourt", Rue = "Rue Gallieni", Numero = "15", IsSalarie = true, Etat = true },
                new SpaPersonne() { Nom = "Muller", Prenom = "Odile", Mail = "omuller@hotmail.com", Ville = "Muret", Rue = "Avenue des Pyrénéees", Numero = "5", IsSalarie = false, Etat = true },
                new SpaPersonne() { Nom = "Jacquet", Prenom = "Jacques", Mail = "jjacquet@free.fr", Ville = "Soissons", Rue = "Avenue de Reims", Numero = "25", IsSalarie = true, Etat = true },
                new SpaPersonne() { Nom = "Renault", Prenom = "Josiane", Mail = "jrenault@gmail.com", Ville = "Nantes", Rue = "Boulevard René Coty", Numero = "10", IsSalarie = true, Etat = true }
            };
